...
const Section2 = () => (
  <section className="flex flex-col items-center justify-center h-screen w-full snap-center bg-black">
    ...
    <main className="grid grid-cols-3 gap-10 w-2/3">
      ...
      <ProjectCard title="LiveOverflow Minecraft server" slug="loserver" date="" description="I participated in a Minecraft server meant to introduce hacking" image="lo.jpg"></ProjectCard>
